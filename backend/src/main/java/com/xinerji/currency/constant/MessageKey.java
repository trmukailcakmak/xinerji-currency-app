...
public class MessageKey {
    ...
    public static final String ERR07 = "ERR07";
    ...
    public static final String ERR014 = "ERR14";
    public static final String ERR015 = "ERR15";
    public static final String ERR016 = "ERR16";
    public static final String ERR017 = "ERR17";
    public static final String ERR018 = "ERR18";
    public static final String ERR019 = "ERR19";
    public static final String ERR020 = "ERR20";
    public static final String ERR021 = "ERR21";
    public static final String ERR022 = "ERR22";
    public static final String ERR023 = "ERR23";
    public static final String ERR024 = "ERR24";
    public static final String ERR025 = "ERR25";
    public static final String ERR026 = "ERR26";
    public static final String ERR027 = "ERR27";
    public static final String ERR028 = "ERR28";
    public static final String ERR029 = "ERR29";
